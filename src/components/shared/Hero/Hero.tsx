...
export default function Hero() {
  ...
  const yText = useTransform(scrollY, [0, 500], [0, -20]); // nuevo
  const gradientRotate = useTransform(scrollY, [0, 500], [0, 90]);
  // The isClient state and useEffect have been removed for simplification,
  // as 'use client' and framer-motion handle this correctly.
  return (
    <section className="relative flex items-center justify-center py-16 px-4 max-w-full sm:py-20 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center">
        {/* --- TEXTO --- */}
        <motion.div
          style={{ y: yText }}
          ...
          className="flex flex-col items-center md:items-start gap-4 sm:gap-6 md:gap-8 w-full px-4"
        >
          <motion.h1
        ...
        >
          ...
          >
            ...
            <Image
              ...
              priority
              placeholder="blur"
              blurDataURL="/img/asaaa.webp" // reemplazado con un archivo existente
...
// The Ripple component has been removed as it was not functioning on click
// and `whileTap` already provides user feedback.
